...
# Petar Marinov, http:/geocities.com/h2428, this is public domain
 ...
 function gwt_refresh() {
  ...
  echo "yes" | cp -f "/cgdrive/c/work/ae$1/gwt/appian-gwt-components/target/appian-gwt-components-0-SNAPSHOT-sources.jar" "/cygdrive/c/work/ae$1/exprdesigner/maven-lib-src/"
 ...
 function gwt_components_delete() {
  cdd "/cygdrive/c/work/ae$1"
  rm -f `find . -iregex .*appian-gwt-components-0-SNAPSHOT.jar`
  rm -f `find . -iregex .*appian-gwt-components-0-SNAPSHOT-sources.jar`
